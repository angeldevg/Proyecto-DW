<%-- 
    ...
    Created on : Nov 14, 2020, 10:04:51 AM
    Author     : Usuario
--%>
    ...
    <body>
        ...
        <header>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-dark">
                ...
                <a class="navbar-brand" href="#"> <img src="images/portadaexamen.png" alt="citas" width="70" height="60">  </a>
                    ...
                    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                        ...
                        <li class="nav-item active">
                            <a class="navbar-brand" href="#">
                                ...
                                <button type="button" onclick="window.location.href = 'examenes.jsp'" class="btn btn-info"><i class="fas fa-undo-alt"></i>Regresar</button>
                ...
                <div class="table-wrapper">
                    ...
                    <table class="table table-striped table-hover text-center">
                        ...
                        <tbody id="tbl_pacientes">
                            ...
                            <%
                                IExamenDao m = new ExamenDao();
                                DefaultTableModel tabla = new DefaultTableModel();

                                tabla = m.GetPrescripcion();
